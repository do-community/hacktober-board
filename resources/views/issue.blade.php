<li>
    ...
    <div class="issue-body">
        ...
        @if ($issue->project_language) <div class="issue-language"><a href="{{ route('issues', ['filter' => ['language' => urlencode($issue->project_language)]]) }}">{{ $issue->project_language }}</a></div> @endif
